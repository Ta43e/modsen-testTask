...
export class AuthController {
    ...
    @ApiResponse({ status: 200, description: 'Successfully authenticated with Google and received user data.' })
    @Get('google/callback')
    @UseGuards(GoogleOauthGuard)
    ...
    @ApiResponse({ status: 200, description: 'Successfully logged in and tokens are returned.' })
